...
class CollectTrainingStatsApp(My_Switch.AdvancedSwitch):
    def __init__(self, *args, **kwargs):
        ...
        with open("DATASet.csv", "w") as file0:
            file0.write(
                'timestamp,datapath_id,flow_id,ip_src,tp_src,ip_dst,tp_dst,ip_proto,icmp_code,icmp_type,flow_duration_sec,flow_duration_nsec,'
                'idle_timeout,hard_timeout,flags,packet_count,byte_count,packet_count_per_second,packet_count_per_nsecond,byte_count_per_second,byte_count_per_nsecond,'
                'total_fwd_packets,total_bwd_packets,total_length_fwd_packets,total_length_bwd_packets,'
                ...
                'max_packet_length,min_packet_length,packet_length_mean,packet_length_std,packet_length_variance,'
                'fwd_header_length,bwd_header_length,min_seg_size_fwd,act_data_pkt_fwd,'
                ...
                'ack_flag_count,urg_flag_count,ece_flag_count,down_up_ratio,avg_packet_size,'
                'init_win_bytes_fwd,init_win_bytes_bwd,active_max,active_min,active_mean,active_std,'
                'idle_max,idle_min,idle_mean,idle_std,fwd_avg_bytes_bulk,fwd_avg_packets_bulk,bwd_avg_bulk_rate,'
                'bwd_avg_packets_bulk,fwd_avg_bulk_rate,bwd_avg_bytes_bulk,avg_fwd_segment_size,avg_bwd_segment_size,'
                'cwe_flag_count,subflow_fwd_packets,subflow_bwd_packets,subflow_fwd_bytes,subflow_bwd_bytes,label\n')
